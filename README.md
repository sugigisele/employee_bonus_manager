...
is a PL/SQL project that demonstrates the use of  Collections, Records, GOTO statements, and Transaction Control through a realistic business scenario.

The project simulates how a company might calculate and manage employee bonuses w##hile handling missing data and database interactions safely.
